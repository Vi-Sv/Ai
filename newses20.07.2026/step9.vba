...
' БЛОК 4 ИЗ 4: ВНЕШНЯЯ ГРУППИРОВКА, НАСТРОЙКА ФОРМАТА ДАТ K, L И СХЛОПЫВАНИЕ
    ...
    wsNew.Range("A2:L" & totalRows).Font.Bold = True
    ...
    ' Форматирование новых столбцов K и L под даты (Ширина 15, Формат даты, Центрирование)
    ...
    MsgBox "Двойной INNER JOIN успешно выполнен. Столбцы дат K и L сформированы.", vbInformation
End Sub
