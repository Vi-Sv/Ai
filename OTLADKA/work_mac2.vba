Sub AggregateDataWithDecadaAndSilent()
    ...
    For Each key In dict.Keys
        ...
        For j = 2 To UBound(decArr, 1)
            ...
            If decKey = key Then
                ...
                ' Аккумуляция рабочих дней из графы K (столбец 9 в decArr)
        ...
        ' Сохраняем общую сумму дней для текущей строки заголовка
    ...
    For i = 1 To rowsColl.Count
        ...
        Next j
        ' Точечная запись суммы рабочих дней в массив (столбец J / индекс 8) без пересборки коллекции
