        ...
        If outArr(i, 1) <> "" Then
            ...
            If dotsCount = 0 Then
                ...
                With newWs.Range("A" & currRow & ":M" & currRow)
                    ...
                    .VerticalAlignment = xlCenter
                End With
                newWs.Rows(currRow).RowHeight = 50 ' Высота строки 50 по ТЗ
            ...
            ElseIf dotsCount = 1 Then
                ...
                With newWs.Range("A" & currRow & ":M" & currRow)
                    .Font.Name = "Times New Roman"
                    .Font.Bold = True
                    .Font.Color = RGB(255, 255, 255) ' Белый контрастный текст
                    .Interior.Color = RGB(85, 95, 105)  ' Матовый благородный Slate Gray
                    .VerticalAlignment = xlCenter
                End With
                newWs.Rows(currRow).RowHeight = 50 ' Высота строки 50 по ТЗ
